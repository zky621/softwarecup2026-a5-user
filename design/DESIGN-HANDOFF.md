# 42552ed6-dad8-43db-b34e-dd3d63b66091 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `scenic-mini-program-prototype-v2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `scenic-mini-program-prototype-v2.html`
...
- A single self-contained `scenic-mini-program-prototype-v2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `scenic-mini-program-prototype-v2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `scenic-mini-program-prototype-v2.html`
- `scenic-mini-program-prototype-v3.html`
- `scenic-mini-program-prototype-v4.html`
- `scenic-mini-program-prototype-v5-motion-polished.html`
- `scenic-mini-program-prototype-v6-delivery-polish.html`
- `scenic-mini-program-prototype-v7-emil-motion.html`
- `scenic-mini-program-prototype.html`
...
1. Inspect `scenic-mini-program-prototype-v2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
